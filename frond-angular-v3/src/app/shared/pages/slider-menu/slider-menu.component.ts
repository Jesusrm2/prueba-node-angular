        ...
        case 1:
          items.push(
            ...
            },
            {
              ...
              command: () => this.navegar('/admin-usuarios'),
            }
          );
          break;
        case 2:
          items.push(
            {
              label: 'Opciones usuario 1',
              icon: 'pi pi-calendar-plus',
              command: () => this.navegar('/asignar-turnos'),
            },
            {
              label: 'Opciones usuario 2',
              icon: 'pi pi-cart-plus',
              command: () => this.navegar('/asignar-caja'),
            },
            {
              label: 'Opciones usuario 3',
              icon: 'pi pi-user-plus',
              command: () => this.navegar('/form-usuario'),
            }
          );
          break;
      }
